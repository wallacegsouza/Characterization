...
from relatorios import GeradorRelatorioTeste
import os
...
path_name = '/home/wallace/workspace/imagensparatratamento/casoteste'

class test_structure_analysis(unittest.TestCase):

    def setUp(self):
        self.report = GeradorRelatorioTeste()

    def test_relatorio_intercepto(self):
        img_name = path_name + '/intercepto.png'
        self.report.run(img_name=img_name, name='intercepto.png')
        report_img = open(img_name)
        
#        for i in os.listdir(self.path_name):
#            print i
